...
public class DbInitializer implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		if (materialRepository.count() == 0 && providerRepository.count() == 0 && providerOffersMatRepository.count() == 0) {
			...
			Material material2 = new Material("Plastico", new HashSet<>(), new HashSet<>());
	        ...
	        ProviderOffersMaterial po2 = new ProviderOffersMaterial(provider1, material2, 20, LocalDate.of(2023, 11, 11), Float.valueOf(100));
